var_inicial = int(input('Insira um valor inicial para a P.G:'))
...
soma = 0
n = 0
if var_inicial and qtd_termos and raz != 0 and sel_elem <= qtd_termos:
    for x in range(cont,qtd_termos +1):
        print(f'{p_g:.3f}', end = ', ')
        soma = soma + p_g
        p_g *= raz
        cont += 1
